...
class PaintingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create painting" do
    assert_difference('Painting.count') do
      post paintings_url, params: { painting: { artist_id: @painting.artist_id, copyright: @painting.copyright, date_created: @painting.date_created, genre: @painting.genre } }
    end
  ...
  test "should update painting" do
    patch painting_url(@painting), params: { painting: { artist_id: @painting.artist_id, copyright: @painting.copyright, date_created: @painting.date_created, genre: @painting.genre } }
